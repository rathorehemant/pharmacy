      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.html">Home</a> <span class="mx-2 mb-0">/</span> <a
              href="shop.html">Store</a> <span class="mx-2 mb-0">/</span> <strong class="text-black"><?php echo $name;?></strong></div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-5 mr-auto">
            <div class="border text-center">
              	<img src="<?php echo $image;?>" height = "500px" width="300px">
            </div>
          </div>
          <div class="col-md-6">
            ...
            <p> <strong class="text-primary h4"> price:<?php echo  $price;?></strong></p>
