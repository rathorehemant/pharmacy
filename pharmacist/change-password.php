...
$sql=mysqli_query($con,"SELECT password FROM  `pharmacist` where password='$password'&& email='".$_SESSION['alogin']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update `pharmacist` set password='$npassword' updationDate='$currentTime' where email='".$_SESSION['alogin']."'");
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>pharmacist Change Password</h3>
							</div>
