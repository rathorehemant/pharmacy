			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<form class="login100-form validate-form" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate="Contact No is required">
						...
						<input class="input100" type="number" name="mo" placeholder="Mobile No">
						<span class="focus-input100"></span>
					</div>
...
if(isset($_POST['submit'])){
	...
	$mo = $_POST['mo'];
	$pass = $_POST['pass'];
	$sql = "INSERT INTO `user`(`name`, `contact`, `email`, `password`) VALUES ('$name','$mo','$email','$pass')";
